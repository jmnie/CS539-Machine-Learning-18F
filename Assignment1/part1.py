...
class Tree(object):
    ...
    def best_attribute(X,Y):
        ...
        #########################################
        ## INSERT YOUR CODE HERE
        info_gain_list = [Tree.information_gain(Y,X[j]) for j in range(len(X))]
        i = np.argmax(info_gain_list)
        #########################################
        return i
    ...
    def stop2(X):
        ...
        #########################################
        ## INSERT YOUR CODE HERE
        s = len(np.unique([len(np.unique(X[i])) for i in range(len(X))])) == 1
        #########################################
        return s
    ...
    def build_tree(t):
        ...
        if Tree.stop1(t.Y) == True or Tree.stop2(t.X) == True:
            ...
            node_dict = Tree.split(t.X,t.Y,index)
            t.C = node_dict
            t.i = index
            for key in node_dict:
                Tree.build_tree(node_dict[key])
        #########################################
    ...
    def inference(t,x):
        ...
        if t.isleaf == True:
            ...
            if key in t.C:
                new_node = t.C[key]
                return Tree.inference(new_node,x)
            else:
                y = t.p
